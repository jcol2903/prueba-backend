...
__decorate([
    ...
    (0, swagger_1.ApiBody)({ type: create_producto_dto_1.CreateProductoDto }),
    (0, swagger_1.ApiResponse)({
        status: 201,
        description: 'Producto creado exitosamente',
        schema: {
            example: {
                id: '228b7a3e-5a54-4186-aadf-b04388e5aa77',
                nombre: 'Laptop Gamer',
                precio: 2500.99,
                stock: 10,
            },
...
__decorate([
    ...
    (0, common_1.UsePipes)(new common_1.ValidationPipe({ whitelist: true })),
    (0, swagger_1.ApiBody)({ type: update_producto_dto_1.UpdateProductoDto }),
    (0, swagger_1.ApiResponse)({
        status: 200,
